...
const consent_html = `
    <p style="text-align:left;">
        ...
        "Truth in Games." You were selected to participate in 
    ...
    <p style="text-align: left;">
        ...
        This study will be conducted through this online survey. The survey 
        should take you XX minutes to complete. There are no direct 
        benefits to you, but you may feel gratified knowing that you helped further 
        the scholarly work in this research area, and you will be compensated $X.XX for your 
        participation. There are no costs to you associated with your participation.
    </p>
    <p style="text-align: left;">
...
const instructions_page1 = `
    <p style="text-align: left">
        ...
        <br>
        <br>
        The approximations of Option 2 were generated by a different set of participants. 
...
const instructions_page7 = `
    ...
    <div id="outcome-wrapper" class="wrapper">
        ...
        They chose Option 2, hoping for 1000 coins, but it turned out that the exact value of Option 2 was only 958 coins.
